...
public class Level1State extends BaseLevelState{
    ...
    public Level1State(GameStateManager gsm) {
        ...
        try {
            ...
            path2.add(new Point(35 * TILE, 9 * TILE));
            path2.add(new Point(35 * TILE, 3 * TILE));
            path2.add(new Point(26 * TILE, 3 * TILE));
            path2.add(new Point(26 * TILE, 9 * TILE));
...
//            ));
    	...
    	coinPositions.add(new int[]{31 * 16 * 3, 6 * 16 * 3});
